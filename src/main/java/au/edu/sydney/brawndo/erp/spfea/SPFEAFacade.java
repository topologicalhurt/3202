...
public class SPFEAFacade {
    ...
    public List<Integer> getAllCustomerIDs() {
        ...
        // **New**
        CustomerValueHolder cvh = CustomerValueHolder.getInstance();
        return cvh.getCachedIds(token);
    ...
    public Customer getCustomer(int id) {
        ...
        // **New**
        // CustomerImpl is expensive to create and should only be created once.
        // Using the lazy value-holder pattern variation, create the customer
        // from the slow database only once.
        CustomerValueHolder cvh = CustomerValueHolder.getInstance();
        return cvh.getCachedCustomers(id, token);
